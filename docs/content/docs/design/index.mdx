...
### [System Architecture](/docs/design/system-architecture)
...
1. **Read [System Architecture](/docs/design/system-architecture)** - Understand the Space model
...
_This documentation reflects the current architecture of Vibex. For implementation details and API references, see the [API Documentation](/docs/api)._
