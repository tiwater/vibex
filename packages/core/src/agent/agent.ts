...
import { ConversationHistory, VibexMessage } from "../space/message";
...
export class Agent {
  ...
  async prepareDebugInfo(options: {
    ...
    // Build context for system prompt generation using VibexMessages
  ...
  async streamText(options: {
    ...
    // Convert VibexMessage[] to ModelMessage[] ONLY here, right before AI SDK call
