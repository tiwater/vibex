        ...
        if (toolCalls && toolCalls.length > 0) {
          toolCalls.forEach((toolCall) => {
            console.log(`[${this.name}] Tool Call:`, {
              ...
              hasFilePath: toolCall.input && typeof toolCall.input === "object" && ("filepath" in toolCall.input || "file_path" in toolCall.input || "path" in toolCall.input),
        ...
        if (toolResults && toolResults.length > 0) {
          toolResults.forEach((result2, index) => {
            console.log(`[${this.name}] Tool Result [${index}]:`, {
              ...
              hasOutput: result2.output !== void 0,
              output: result2.output,
              providerExecuted: result2.providerExecuted
            });
          });
        }
      },
...
`;
  ...
  static async start(goal, options = {}) {
    ...
    const { startSpace: startSpace2 } = await import("./space-XTFUL2DM.mjs");
