...
var WorkflowEngine = class extends EventEmitter {
  ...
  evaluateCondition(_context, step) {
...
Use "condition" for decision points.`,
   ...
   */
  handleMessagePersistence(streamResult, _messages, spaceId, metadata) {
    (async () => {
      try {
        let finalText = "";
...
`;
  ...
  static async start(goal, options = {}) {
    ...
    const { startSpace: startSpace2 } = await import("./space-ESA65HYY.mjs");
