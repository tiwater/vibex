...
import type { StorageAdapter, ArtifactInfo, ArtifactType } from "@vibex/core";
import { LocalResourceAdapter } from "./resource";
...
export class LocalStorageAdapter implements StorageAdapter {
  ...
  async saveArtifact(
    ...
    const fullArtifact: ArtifactType = {
      ...artifact,
      spaceId,
    };
  ...
  async getArtifactInfo(
    ...
    if (!artifact || artifact.spaceId !== spaceId) return null;
