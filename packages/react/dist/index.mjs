...
function useVibexSpace(spaceId) {
  ...
  const updateSpace2 = useCallback(
    async (updates) => {
  ...
  const deleteSpace2 = useCallback(async () => {
    if (!spaceId) throw new Error("No space ID provided");
    setLoading(true);
    try {
...
function useVibexSpaces(filters) {
  ...
  const createSpace2 = useCallback(async (space) => {
    setLoading(true);
    try {
...
function useVibexArtifacts(spaceId, filters) {
  ...
  const createArtifact2 = useCallback(
    async (artifact) => {
      if (!spaceId) throw new Error("No space ID provided");
      setLoading(true);
      try {
  ...
  const updateArtifact2 = useCallback(
  ...
  const deleteArtifact2 = useCallback(
    async (artifactId) => {
      if (!spaceId) throw new Error("No space ID provided");
      setLoading(true);
      try {
...
var VibexErrorBoundary = class extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    if (this.state.hasError) {
      ...
      return /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center p-8 text-center", children: [
        /* @__PURE__ */ jsx2("h2", { className: "text-lg font-semibold mb-2", children: "Something went wrong" }),
        /* @__PURE__ */ jsx2("p", { className: "text-sm text-muted-foreground mb-4", children: this.state.error?.message || "An unexpected error occurred" }),
        /* @__PURE__ */ jsx2(
          "button",
          {
